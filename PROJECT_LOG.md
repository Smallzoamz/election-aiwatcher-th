...
[17/01/2026 19:35] | File: multiple | Keyword: Duplicate Fix | Status: Fixed | Change: Multi-layered fix for duplicate news: 1) Fixed Set logic in ai-engine.js (link vs headline) 2) Removed duplicate key in API response 3) Implemented sequential deduplication on frontend (page.js) 4) Enhanced availableNews filtering by link.
