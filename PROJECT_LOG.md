...
[17/01/2026 20:15] | File: lib/ai-engine.js | Line: Multiple | Keyword: Wikipedia Trends | Status: Edited | Change: Integrated real-time Wikipedia pageviews into scoring system and enforced 40/60-70/30 weight formula.
[17/01/2026 20:20] | File: Multiple | Line: N/A | Keyword: Big Cleaning Day | Status: Deleted | Change: Removed dead files (rss-fetcher, pantip-scraper, youtube-fetcher, CandidateTooltip) and cleaned up unused constants/imports. Verified over 3 rounds.
[2026-01-17 21:15] | File: lib/ai-engine.js | Line: [Multi] | Keyword: Integrity Re-check | Status: Fixed/Restored | Change: Standardized srt ID, restored regional sources, restored missing UI fields (nidaScore, delta, impact, context), and synchronized version to 3.0.
[2026-01-17 14:05] | File: lib/ai-engine.js | Line: 268-850 | Keyword: QWHS/Sentiment | Status: Edited | Change: Integrated Social RSS feeds, implemented Quad-Weighted Hybrid Score (QWHS), Dual-Stage Sentiment Analysis, and Margin of Error (MoE). Refactored simulateMarket for structural integrity.
[2026-01-17 14:10] | File: app/methodology/page.js | Line: 25-305 | Keyword: Methodology/v3.0 | Status: Edited | Change: Updated methodology page to version 3.0, documented new QWHS weights and social data sources.
[17/01/2026 19:24] | File: lib/ai-engine.js | Line: 857, 986 | Keyword: Deduplication | Status: Edited | Change: Enhanced news deduplication with aggressive headline normalization and link parameter stripping to prevent duplicates in UI ticker.
[17/01/2026 19:35] | File: lib/ai-engine.js | Line: [Multi] | Keyword: Deduplication | Status: Edited | Change: Normalized headline keys strictly (removed Thai tones/whitespace) between marking and checking to prevent duplicate news processing.
[17/01/2026 19:37] | File: lib/ai-engine.js | Line: [Multi] | Keyword: Database | Status: Edited | Change: Implemented double-marking (Headline & Link) in DB to ensure total isolation of consumed news.
[16/01/2026 00:08] | File: lib/rss-fetcher.js | Line: 15 | Keyword: fetchLiveNews | Status: Edited | Change: Removed slice limit, reduced cache to 60s
[16/01/2026 00:08] | File: lib/ai-engine.js | Line: 40 | Keyword: simulateMarket | Status: Edited | Change: Implemented unique news tracking using headline text
[16/01/2026 00:08] | File: lib/db.js | Line: 1 | Keyword: DB Logic | Status: Created | Change: Implemented JSON file-based database for persistence
[16/01/2026 00:08] | File: lib/ai-engine.js | Line: 38 | Keyword: DB Integration | Status: Edited | Change: Connected to lib/db.js, added party-based categorization
...
[17/01/2026 19:35] | File: lib/ai-engine.js | Line: [Multi] | Keyword: Deduplication | Status: Edited | Change: Normalized headline keys strictly (removed Thai tones/whitespace) between marking and checking to prevent duplicate news processing.
[17/01/2026 19:37] | File: lib/ai-engine.js | Line: [Multi] | Keyword: Database | Status: Edited | Change: Implemented double-marking (Headline & Link) in DB to ensure total isolation of consumed news.
[17/01/2026 19:40] | File: app/page.js | Line: 196-209 | Keyword: UI/UX | Status: Edited | Change: Added global history deduplication in polling logic to stabilize news ticker rendering.
[17/01/2026 19:45] | File: test_rss.mjs | Line: [All] | Keyword: Audit | Status: Created | Change: Completed full 11-source RSS audit (all verified 200 OK) to ensure data pipeline reliability.
[17/01/2026 19:50] | File: lib/ai-engine.js | Line: [Header] | Keyword: Core | Status: Edited | Change: Fixed structural syntax errors and switched to native node-fetch for better performance and ESM compatibility.
[2026-01-17 21:30] | File: app/components/StructuredData.js | Keyword: SEO | Status: Edited | Change: Implemented Advanced SEO Schema (FAQ, Dataset) for Google Rich Results.
[2026-01-17 21:35] | File: app/components/Monetization.js | Keyword: Monetization | Status: Created | Change: Implemented Cyber-styled Monetization system (Ad placeholders, Support button, Pro Teaser).
[2026-01-17 21:40] | File: app/layout.js, page.js | Keyword: GEO | Status: Edited | Change: Integrated regional SEO keywords and GEO Intelligence Status Radar for local targeting.
...
[18/01/2026 21:00] | File: multiple | Line: N/A | Keyword: Audit/Cleanup | Status: Completed | Change: Removed junk files (pantip_agent, debug logs), deleted unused dependencies (google-trends-api, pg), and purged dead code in ai-engine.js/db.js. Verified system stability.[30/01/2026 16:08] | File: nida-data.json | Line: N/A | Keyword: NIDA Poll | Status: Updated | Change: Updated NIDA Poll data to "Round 2" results (Jan 27, 2026). PP: 34.20%, BJT: 22.60%, PT: 16.20%, DEM: 13.20%.
[30/01/2026 16:08] | File: lib/ai-engine.js | Line: 412 | Keyword: NIDA Poll | Status: Updated | Change: Updated FALLBACK_NIDA_DATA to match Round 2 results for consistency.
