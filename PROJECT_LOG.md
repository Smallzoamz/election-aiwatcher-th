...
[17/01/2026 19:35] | File: multiple | Keyword: Duplicate Fix | Status: Fixed | Change: Multi-layered deep fix for duplicates: 1) Normalized headline keys strictly (removed Thai tones/whitespace) between marking and checking 2) Implemented double-marking (Headline & Link) in DB 3) Added global history deduplication in page.js 4) Completed full 11-source RSS audit (all verified 200 OK) 5) Fixed syntax errors and switched to native node-fetch.
