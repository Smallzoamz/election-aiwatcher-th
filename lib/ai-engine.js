...
export const PARTIES = [
    { id: 'pp', name: "พรรคประชาชน", color: '#F47933', baseScore: 40, candidates: ["ณัฐพงษ์ เรืองปัญญาวุฒิ", "ศิริกัญญา ตันสกุล", "วีระยุทธ กาญจน์ชูฉัตร"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/People%27s_Party_Logo-TH_%28Thailand%2C_2024%29.svg/1200px-People%27s_Party_Logo-TH_%28Thailand%2C_2024%29.svg.png" },
    { id: 'pt', name: "พรรคเพื่อไทย", color: '#E3000F', baseScore: 25, candidates: ["ยศชนัน วงศ์สวัสดิ์", "สุริยะ จึงรุ่งเรืองกิจ", "จุลพันธ์ อมรวิวัฒน์"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Logo_of_the_Pheu_Thai_Party.svg/1200px-Logo_of_the_Pheu_Thai_Party.svg.png" },
    { id: 'utn', name: "พรรครวมไทยสร้างชาติ", color: '#2D427D', baseScore: 12, candidates: ["พีระพันธุ์ สาลีรัฐวิภาค"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Logo_of_the_United_Thai_Nation_Party.svg/1200px-Logo_of_the_United_Thai_Nation_Party.svg.png" },
    { id: 'bjt', name: "พรรคภูมิใจไทย", color: '#0B1F4F', baseScore: 10, candidates: ["อนุทิน ชาญวีรกูล"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Bhumjaithai_Party_Logo.svg/1200px-Bhumjaithai_Party_Logo.svg.png" },
    { id: 'dem', name: "พรรคประชาธิปัตย์", color: '#40C0F0', baseScore: 5, candidates: ["เฉลิมชัย ศรีอ่อน"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Democrat_Party_%28Thailand%29_Symbol.svg/1200px-Democrat_Party_%28Thailand%29_Symbol.svg.png" },
    { id: 'pprp', name: "พรรคพลังประชารัฐ", color: '#1E3A8A', baseScore: 4, candidates: ["พล.อ.ประวิตร วงษ์สุวรรณ"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Palang_Pracharath_Party_Logo.svg/1200px-Palang_Pracharath_Party_Logo.svg.png" },
    { id: 'cpd', name: "พรรคชาติไทยพัฒนา", color: '#15803D', baseScore: 2, candidates: ["วราวุธ ศิลปอาชา"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Chartthaipattana_Party_Logo.svg/1200px-Chartthaipattana_Party_Logo.svg.png" },
    { id: 'tst', name: "พรรคไทยสร้างไทย", color: '#DC2626', baseScore: 1, candidates: ["คุณหญิงสุดารัตน์ เกยุราพันธุ์"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Thai_Sang_Thai_Party_Logo.svg/1200px-Thai_Sang_Thai_Party_Logo.svg.png" },
    { id: 'srt', name: "พรรคเสรีรวมไทย", color: '#7C3AED', baseScore: 1, candidates: ["พล.ต.อ.เสรีพิศุทธ์ เตมียเวส"], logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Thai_Liberal_Party_logo.svg/1200px-Thai_Liberal_Party_logo.svg.png" },
    { id: 'tkm', name: "พรรคไทยก้าวใหม่", color: '#0EA5E9', baseScore: 1, candidates: ["ดร.สุชัชวีร์ สุวรรณสวัสดิ์"] },
    { id: 'okm', name: "พรรคโอกาสใหม่", color: '#EC4899', baseScore: 1, candidates: ["รอการเปิดตัว"] },
    { id: 'econ', name: "พรรคเศรษฐกิจ", color: '#10B981', baseScore: 1, candidates: ["พล.อ.รังษี กิติญาณทรัพย์"] },
];
