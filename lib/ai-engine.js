...
export const PARTIES = [
    ...
    { id: 'pprp', name: "พรรคพลังประชารัฐ", color: '#1E3A8A', baseScore: 4 },
    { id: 'cpd', name: "พรรคชาติไทยพัฒนา", color: '#15803D', baseScore: 2 },
    { id: 'tst', name: "พรรคไทยสร้างไทย", color: '#DC2626', baseScore: 1 },
    { id: 'srt', name: "พรรคเสรีรวมไทย", color: '#7C3AED', baseScore: 1 },
    { id: 'tkm', name: "พรรคไทยก้าวใหม่", color: '#0EA5E9', baseScore: 1 }, // New trending party
    { id: 'okm', name: "พรรคโอกาสใหม่", color: '#EC4899', baseScore: 1 },   // New trending party
];
