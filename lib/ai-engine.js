...
export const PARTIES = [
    { id: 'pp', name: "พรรคประชาชน", color: '#F47933', baseScore: 40, candidates: ["ณัฐพงษ์ เรืองปัญญาวุฒิ", "ศิริกัญญา ตันสกุล", "วีระยุทธ กาญจน์ชูฉัตร"] },
    { id: 'pt', name: "พรรคเพื่อไทย", color: '#E3000F', baseScore: 25, candidates: ["ยศชนัน วงศ์สวัสดิ์", "สุริยะ จึงรุ่งเรืองกิจ", "จุลพันธ์ อมรวิวัฒน์"] },
    { id: 'utn', name: "พรรครวมไทยสร้างชาติ", color: '#2D427D', baseScore: 12, candidates: ["พีระพันธุ์ สาลีรัฐวิภาค"] },
    { id: 'bjt', name: "พรรคภูมิใจไทย", color: '#0B1F4F', baseScore: 10, candidates: ["อนุทิน ชาญวีรกูล"] },
    { id: 'dem', name: "พรรคประชาธิปัตย์", color: '#40C0F0', baseScore: 5, candidates: ["เฉลิมชัย ศรีอ่อน"] },
    { id: 'pprp', name: "พรรคพลังประชารัฐ", color: '#1E3A8A', baseScore: 4, candidates: ["พล.อ.ประวิตร วงษ์สุวรรณ"] },
    { id: 'cpd', name: "พรรคชาติไทยพัฒนา", color: '#15803D', baseScore: 2, candidates: ["วราวุธ ศิลปอาชา"] },
    { id: 'tst', name: "พรรคไทยสร้างไทย", color: '#DC2626', baseScore: 1, candidates: ["คุณหญิงสุดารัตน์ เกยุราพันธุ์"] },
    { id: 'srt', name: "พรรคเสรีรวมไทย", color: '#7C3AED', baseScore: 1, candidates: ["พล.ต.อ.เสรีพิศุทธ์ เตมียเวส"] },
