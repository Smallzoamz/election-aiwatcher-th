...
export const PARTIES = [
    { id: 'pp', name: "พรรคประชาชน", color: '#F47933', baseScore: 40, candidates: ["ณัฐพงษ์ เรืองปัญญาวุฒิ"] },
    { id: 'pt', name: "พรรคเพื่อไทย", color: '#E3000F', baseScore: 25, candidates: ["แพทองธาร ชินวัตร", "ชัยเกษม นิติสิริ"] },
    ...
    { id: 'dem', name: "พรรคประชาธิปัตย์", color: '#40C0F0', baseScore: 5, candidates: ["เฉลิมชัย ศรีอ่อน", "อภิสิทธิ์ เวชชาชีวะ"] },
