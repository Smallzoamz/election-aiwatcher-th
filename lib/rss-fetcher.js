...
// Thai news RSS feeds - VERIFIED WORKING
const RSS_FEEDS = [
    ...
    { url: 'https://www.mgronline.com/rss/politics.xml', source: 'ผู้จัดการออนไลน์', weight: 1.2 },

    // General news feeds (may include politics)
    { url: 'https://www.matichon.co.th/feed', source: 'มติชน (ทั่วไป)', weight: 0.8 },
    { url: 'https://www.prachachat.net/feed', source: 'ประชาชาติ (ทั่วไป)', weight: 0.8 },
];
