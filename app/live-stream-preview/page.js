    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 md:p-8">
                        ...
                        {STREAMING_CHANNELS.map((channel, index) => {
                            ...
                            return (
                                <a
                                    ...
                                    className={`group relative bg-gradient-to-br ${channel.color} rounded-2xl p-5 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-${channel.color.split('-')[1]}-500/20 ${channel.priority ? 'ring-2 ring-amber-400/50 sm:col-span-2 lg:col-span-1' : ''}`}
                                >
                                    {/* Priority Badge */}
                                    {channel.priority && (
                ...
                {/* Mockup Badge */}
                <div className="fixed bottom-4 right-4 bg-amber-500/90 text-black font-bold text-xs px-3 py-1.5 rounded-full shadow-lg">
                    🎨 MOCKUP PREVIEW
                </div>
            </div>
        </div>
